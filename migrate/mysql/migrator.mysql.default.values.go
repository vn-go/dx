...
func (m *MigratorMySql) GetGetDefaultValueByFromDbTag() map[string]string {
	return map[string]string{
		...
		"true":               "TRUE",
		"false":              "FALSE",
		"uuid()":             common.SkipDefaulValue, // vdb::cancel=> skip create default value in DB if mach uuid()
		"uuid_generate_v4()": common.SkipDefaulValue, // vdb::cancel=> skip create default value in DB if mach uuid_generate_v4()
	}
}
